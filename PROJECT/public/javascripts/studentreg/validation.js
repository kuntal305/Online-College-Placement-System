...
function mobnocheck(){
    ...
    if(mobileno===null||mobileno===""){
        document.getElementById("mobileno").style.backgroundColor = 'Red';
...
function mobnomsgclear(){
    document.getElementById("mobileno").style.backgroundColor = 'White';
...
function conpwdcheck(){
    ...
    if(password!=conpassword){
        document.getElementById("cpassword").backgroundColor='Red';
...
function conpwdmsgclr(){
    if(document.getElementById("password").value===""||document.getElementById("password").value===null){
        ...
        document.getElementById("cpassword").backgroundColor="White";
        document.getElementById("cpwdmsg").innerHTML="";
    }
}